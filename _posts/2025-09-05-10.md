...
In this article, we'll learn how a C program is converted into an executable file, the structure of ELF, memory segments, and the basics of using a debugger through a Hello World program. The materials for this chapter are in the [chapter_02](https://github.com/r1ru/binary-exploitation-101/tree/main/chapter_02) folder.
